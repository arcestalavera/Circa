function addComment(postID) {
    $.ajax({
        type: "POST",
        url: "Comment?action=add&id=" + postID + "&curpage=home",
...
function deleteComment(commentID) {
    $.ajax({
        type: "POST",
        url: "Comment?action=delete&id=" + commentID + "&curpage=home",
        success: function() {
...
function likePost(postID, userID, count) {
    $.ajax({
        type: "POST",
        url: "Like?action=like&pid=" + postID + "&uid=" + userID + "&curpage=home",
        success: function() {
            count++;
            if (count === 1)
            {
...
function unlikePost(postID, userID, count) {
    $.ajax({
        type: "POST",
        url: "Like?action=unlike&pid=" + postID + "&uid=" + userID + "&curpage=home",
        success: function() {
            count--;
